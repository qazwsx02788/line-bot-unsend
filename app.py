    ...
    # --- 🀄 遊戲核心 ---
        ...
        if not game['banker_id']:
            ...
            if user_id in game['played_users']:
                # 🔥 [修復點] 這裡就是之前出錯的地方，現在補齊了
                log = {
                    'winner_id': game['banker_id'], 
                    'winner_name': game['banker_name'], 
                    'loser_id': user_id, 
